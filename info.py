...
URL = "https://{https://filestreampro-21f4b457b795.herokuapp.com}/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://{https://filestreampro-21f4b457b795.herokuapp.com}/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://{https://filestreampro-21f4b457b795.herokuapp.com}/".format(FQDN)
else:
    URL = "https://{https://filestreampro-21f4b457b795.herokuapp.com}/".format(FQDN)
